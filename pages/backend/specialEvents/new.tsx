...
export default function NewSpecialEventPage({ session }: { session: Session }) {
  ...
  return (
    <BackendPermissionGuard
      ...
      deniedDescription="Du hast keine Berechtigung, Special Events im Backend zu erstellen."
    >
