...
export default function FriendsFamilyReservationPage({
  ...
  return (
    <BackendPermissionGuard
      ...
      deniedTitle="Kein Zugriff auf Friends & Family Reservierungen"
      deniedDescription="Du hast keine Berechtigung, Friends & Family Reservierungen im Backend zu verwalten."
    >
