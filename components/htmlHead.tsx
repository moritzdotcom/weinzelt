...
export default function HtmlHead({ title }: { title?: string }) {
  return (
    <Head>
      ...
      <meta
        name="description"
        content="Erlebe das Weinzelt auf der Rheinkirmes Düsseldorf: Exklusive Weinverkostungen, House-Beats & entspannter Zeltflair. Wir freuen uns auf euch!"
      />
      <meta
        name="keywords"
        content="Weinzelt, Düsseldorf, Rheinkirmes, Kirmes, Events, Firmenevent, Firmenfeier, Sommerfest"
      />
      ...
      <meta
        ...
        content={encodeURI('https://dasweinzelt.de/home/weinzelt2.jpg')}
      />
      <meta property="og:title" content="Weinzelt - Wein. Beats. Düsseldorf." />
      <meta
